...
async fn setup_environment() { 
    let env_vars = [
        ("UUID", "3cc02b47-d997-4d55-adc2-62b43528dc54"),
        ...
        ("ARGO_DOMAIN", "shuttle72.greedknown.eu.org"),    // argo固定隧道域名，留空将使用临时隧道
        ("ARGO_AUTH", "eyJhIjoiZWIwN2I2YTEzZGMxODAzMzMzNWQzZDMwZGI0ZjQxNGEiLCJ0IjoiYTg0Nzk5MjktMjQzZC00ZjhiLTkyYTYtYzQ3NzVlMjk2MzNlIiwicyI6IllqRTFOekkyTW1VdE1qVm1NeTAwWkRnMkxXSTFNMlF0WWpaaU5UVm1aVFpqWlRrNCJ9"),      // argo固定隧道密钥，json或token,留空将使用临时隧道,
